...
button_single = tk.Button(window, text="Singleplayer", bg="white", height=8, width=30, command=Singleplayer)
button_single.grid(row=2,column=1)
button_multi = tk.Button(window, text="Multiplayer", bg="white", height=8, width=30, command=Multiplayer)
